...
يصلح هذا الـ skill لأي agent harness يَعرف تحميل الـ skills. يستخدم الأمر أدناه `~/.claude/skills/` كمسار مثال؛ إذا كان harness لديك يَستخدم مُجلَّد skills مختلفاً فاستبدله بالمسار المناسب.
...
ثمَّ افتح جلسة agent جديدة لتحديث قائمة الـ skills.
