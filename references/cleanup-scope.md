...
| Weights & Biases (`~/.wandb` present, dir probe) | `~/.wandb/` (global W&B run cache; per-project `.wandb/` dirs are not swept — too scattered). | `pkg_cache` |
